...
function convertRun() {
    ...
    console.log("The hex value of " + color + " is " + convert(color));

    var colorHEX = convert(color);

    // Example usage:
    var colorRGB = hexToRgb(colorHEX); // Red
    console.log(colorRGB); // Output: { r: 255, g: 0, b: 0 }
}
...
function setColor() { 
    rgbValue[0] = rgbValue[0];
    rgbValue[1] = rgbValue[1];
    rgbValue[2] = rgbValue[2];
